...
(
    ...
    daily_norm_calories numeric(4, 2)
);
...
(
    id                     bigserial not null
        constraint days_pkey
            primary key,
    date                   date      not null,
    calories_consumed      numeric(5, 2),
    user_id                bigint
        constraint fkabs3l4rw11qk2t7fj61rhliy
            references users,
    exceeded_calories      numeric(5, 2) default 0,
